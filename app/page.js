...
export default function Page() {
    ...
    return (
        <main className="container mx-auto p-4">
            <h1 className="flex font-bold text-xl justify-center top-0 left-1/2 transform -translate-x-1/2">Movie Suggestions 4 U</h1>

            <div className="flex relative justify-center gap-5 mb-4">
                <select
                    value={ageRating}
